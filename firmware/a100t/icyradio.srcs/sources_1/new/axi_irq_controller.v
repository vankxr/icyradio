...
always @(posedge aclk)
    begin
        if(!aresetn)
            ...
            begin
                irq_in_q <= irq_in_sync;

                irq_in_rising <= irq_in_sync & ~irq_in_q;
                irq_in_falling <= ~irq_in_sync & irq_in_q;
            end
    end
