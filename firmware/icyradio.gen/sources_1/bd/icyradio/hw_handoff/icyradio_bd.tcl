...
proc create_root_design { parentCell } {
  ...
  if { [catch {set axi_gpio_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
   ...
   CONFIG.GPIO_OUT_DEFAULT {0x07000000} \
 ] $axi_gpio_2
