...
#set_property IOSTANDARD LVCMOS25 [get_ports 5V0_TRX_PA1_OCn]
#set_property IOSTANDARD LVCMOS25 [get_ports 5V0_TRX_PA2_OCn]
#set_property IOSTANDARD LVCMOS25 [get_ports 5V0_TRX_BIAS_T1_OCn]
#set_property IOSTANDARD LVCMOS25 [get_ports 5V0_TRX_BIAS_T2_OCn]
#set_property PACKAGE_PIN A19 [get_ports 5V0_TRX_PA1_OCn]
#set_property PACKAGE_PIN A21 [get_ports 5V0_TRX_PA2_OCn]
#set_property PACKAGE_PIN A20 [get_ports 5V0_TRX_BIAS_T1_OCn]
#set_property PACKAGE_PIN A18 [get_ports 5V0_TRX_BIAS_T2_OCn]
