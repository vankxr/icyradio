...
set_property IOSTANDARD LVCMOS33 [get_ports CODEC_I2S_SDOUT]
set_property IOSTANDARD LVCMOS33 [get_ports CODEC_I2S_SDIN]
set_property PACKAGE_PIN V17 [get_ports CODEC_I2S_BCLK]
set_property PACKAGE_PIN W17 [get_ports CODEC_I2S_LRCLK]
set_property PACKAGE_PIN AA15 [get_ports CODEC_I2S_SDOUT]
set_property PACKAGE_PIN W16 [get_ports CODEC_I2S_SDIN]
