...
fir_interpolator_ctx_t* fir_interpolator_init(uint16_t usNumTaps, uint8_t ubInterpolationFactor, int16_t *psCoefs, int16_t *psState, uint32_t ulBlockSize);
...
fir_interpolator_complex_ctx_t* fir_interpolator_complex_init(uint16_t usNumTaps, uint8_t ubInterpolationFactor, int16_t *psCoefs, iq16_t *pState, uint32_t ulBlockSize);
