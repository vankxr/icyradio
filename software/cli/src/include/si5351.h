...
// Clock assignment
#define SI5351_FPGA_CLK2     0
#define SI5351_FPGA_CLK3     1
#define SI5351_FPGA_CLK0     2
#define SI5351_FPGA_CLK1     3
#define SI5351_TRX_REF_CLK   4
#define SI5351_SYNTH_REF_CLK 5
#define SI5351_EXT_CLK_2_3   6
#define SI5351_EXT_CLK_OUT   7
