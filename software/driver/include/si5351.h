...
extern uint64_t SI5351_XTAL_FREQ;
extern uint64_t SI5351_CLKIN_FREQ;
extern uint64_t SI5351_CLKIN_DIV_FREQ;
extern uint64_t SI5351_PLL_SRC_FREQ[2];
extern uint64_t SI5351_PLL_FREQ[2];
extern uint64_t SI5351_MS_SRC_FREQ[8];
extern uint64_t SI5351_MS_FREQ[8];
extern uint64_t SI5351_CLK_SRC_FREQ[8];
extern uint64_t SI5351_CLK_FREQ[8];

void set_pbar(void *p);

uint8_t si5351_init(void);
void si5351_isr(void);

uint8_t si5351_read_revision_id(void);
uint8_t si5351_read_status(void);
