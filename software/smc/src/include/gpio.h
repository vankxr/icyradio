...
// RXTUNER MACROS
#define RXTUNER_REF_16M()   PERI_REG_BIT_SET(&(GPIO->P[3].DOUT)) = BIT(15)
#define RXTUNER_REF_28M8()  PERI_REG_BIT_CLEAR(&(GPIO->P[3].DOUT)) = BIT(15)
...
#define TXPLL_MUTE()        PERI_REG_BIT_SET(&(GPIO->P[5].DOUT)) = BIT(8)
#define TXPLL_UNMUTE()      PERI_REG_BIT_CLEAR(&(GPIO->P[5].DOUT)) = BIT(8)
