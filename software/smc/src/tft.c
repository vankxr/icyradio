...
{
    CMU->HFPERCLKEN0 |= CMU_HFPERCLKEN0_TIMER4;

    TIMER4->CTRL = TIMER_CTRL_RSSCOIST | TIMER_CTRL_PRESC_DIV1 | TIMER_CTRL_CLKSEL_PRESCHFPERCLK | TIMER_CTRL_FALLA_NONE | TIMER_CTRL_RISEA_NONE | TIMER_CTRL_MODE_UP;
    TIMER4->TOP = (HFPER_CLOCK_FREQ / ulFrequency) - 1;
    TIMER4->CNT = 0x0000;

    TIMER4->CC[0].CTRL = TIMER_CC_CTRL_PRSCONF_LEVEL | TIMER_CC_CTRL_CUFOA_NONE | TIMER_CC_CTRL_COFOA_SET | TIMER_CC_CTRL_CMOA_CLEAR | TIMER_CC_CTRL_MODE_PWM;
    TIMER4->CC[0].CCV = 0x0000;

    TIMER4->ROUTELOC0 = TIMER_ROUTELOC0_CC0LOC_LOC7;
    TIMER4->ROUTEPEN |= TIMER_ROUTEPEN_CC0PEN;
...
void tft_bl_set(float fBrightness)
{
    ...
    TIMER4->CC[0].CCVB = TIMER4->TOP * fBrightness;
}
