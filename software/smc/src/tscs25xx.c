...
uint8_t tscs25xx_init()
{
    ...
    tscs25xx_write_register(TSCS25XX_REG_CONFIG0, TSCS25XX_REG_CONFIG0_ASDM_FULL | TSCS25XX_REG_CONFIG0_DSDM_FULL | TSCS25XX_REG_CONFIG0_DC_FILTER_ON | TSCS25XX_REG_CONFIG0_SD_NO_FORCE_ON);
